  ...
  return (
    <div className="page-enter">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(135deg, rgba(17,22,64,0.93) 0%, rgba(30,42,138,0.88) 100%), url('https://images.pexels.com/photos/1477519/pexels-photo-1477519.jpeg?auto=compress&cs=tinysrgb&w=1600')`,
      ...
      >
        <div className="page-container text-center text-white">
          ...
          <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4">Statement of Faith</h1>
