  ...
  return (
    <div className="page-enter">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(135deg, rgba(17,22,64,0.93) 0%, rgba(30,42,138,0.88) 100%), url('https://images.pexels.com/photos/267885/pexels-photo-267885.jpeg?auto=compress&cs=tinysrgb&w=1600')`,
      ...
      >
        <div className="page-container text-center text-white">
          ...
          <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4">Prologue</h1>
            ...
            <div className="card p-6 hover:shadow-md transition-shadow">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed">
                    Aizawl Bible College is an accredited Institution by the <strong className="text-navy-800">Assemblies of God Association for Theological Education of South Asia (AGATESA)</strong>.
                  </p>
                </div>
              </div>
            </div>
